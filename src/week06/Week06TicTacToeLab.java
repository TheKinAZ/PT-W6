...
//
//	Objectives:
//		1. Implement a Tic-Tac-Toe game board
//		2. Use the Scanner to incorporate User Input
//		3. Validate User Input -- error checking
//		4. Use the skills that you have learned in Weeks 1-6
//		5. Read our set of requirements and rules and Implement as requested
//	
// Rules:  
...
//				Alternatively, you could create an object with its own methods (e.g. GameBoard.java). 
//		NOTE:	Per Labs video, this step was accomplished by setting up the file!
//
...
// START YOUR IMPLEMENTATION BELOW THIS LINE
		...
		public static void main(String[] args) {
			...
			while (winner.equals("") && allSquares <= 9) {
				System.out.println(player + "'s turn: -- please enter a number designating a square to place your "
						+ player + " into: ");
				...
				if (squareNumber > 0 && squareNumber <= 9) {
					if (gameBoard.ifValidSetSquare(squareNumber, readInput, player)) {
						...
						System.out.println("Square has already been used!");
					}
				}
			...
			if (winner.equals("draw")) {
				System.out.println("Sorry, this game was a " + winner + "!");
			} else {
